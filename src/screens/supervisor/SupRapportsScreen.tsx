...
const styles = StyleSheet.create({
  ...
  sentText:   { fontSize:rf(13), fontWeight:"700", color:C.success },
  ...
  sendBtnText:{ color:"#fff", fontSize:rf(15), fontWeight:"700" },
  histCard:   { backgroundColor:C.surface, borderWidth:1, borderColor:C.border, borderRadius:rs(14), overflow:"hidden" },
  histTitle:  { fontSize:rf(13), fontWeight:"700", color:C.text, padding:rs(14), borderBottomWidth:1, borderBottomColor:C.border },
  ...
  histDate:   { fontSize:rf(13), fontWeight:"700", color:C.text },
  histSub:    { fontSize:rf(11), color:C.textMuted, marginTop:rs(1) },
  histBtn:    { fontSize:rf(11), fontWeight:"700", color:C.textMuted },
  ...
  sheetSub:   { fontSize:rf(12), color:C.textMuted, marginTop:-rs(8) },
  qLabel:     { fontSize:rf(13), fontWeight:"600", color:C.text, marginBottom:rs(8) },
  ...
  toggleText: { fontSize:rf(14), fontWeight:"700", color:C.textMuted },
  bilanBtn:   { flex:1, padding:rs(11), borderRadius:rs(11), borderWidth:2, borderColor:C.border, alignItems:"center" },
  bilanText:  { fontSize:rf(13), fontWeight:"700", color:C.textMuted },
  textarea:   { borderWidth:1.5, borderColor:C.border, borderRadius:rs(11), padding:rs(10), color:C.text, fontSize:rf(13), minHeight:rs(80), textAlignVertical:"top", backgroundColor:C.bg },
  ...
  detailKey:  { fontSize:rf(13), color:C.textMuted },
  detailVal:  { fontSize:rf(14), fontWeight:"700", color:C.text },
  closeBtn:   { backgroundColor:C.surfaceAlt, padding:rs(13), borderRadius:rs(12), alignItems:"center" },
  closeBtnText: { fontSize:rf(14), fontWeight:"600", color:C.text },
});
