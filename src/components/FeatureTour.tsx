...
const SUPERVISOR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    points: [
      "Touchez la carte pour le marquer présent.",
      "« Marquer absent » demande un motif : choisissez un motif prédéfini ou décrivez le vôtre.",
      "Quand tout le monde est pointé, touchez « Confirmer » pour valider la liste du jour.",
    ],
    href: "/(supervisor-tabs)/presences",
    spot: "middle",
  },
  {
    key: "evaluation",
    icon: "list",
    title: "Évaluation : tester le niveau des élèves",
    desc: "Cet onglet vous permet de faire passer les tests ASER aux élèves, directement depuis votre téléphone.",
    href: "/(supervisor-tabs)/evaluation",
    tabIndex: 1,
  },
  {
    key: "evaluation-deroule",
    target: "sup.evaluation.contenu",
    icon: "book",
    title: "Dérouler un test ASER",
    desc: "Choisissez d'abord le dossier d'évaluation (Seereer, Pulaar ou Wolof), puis suivez les consignes affichées :",
    points: [
      "Lecture : lettres à reconnaître, syllabes puis mots à lire.",
      "Mathématiques : opérations à résoudre.",
      "Notez les réponses de l'élève au fur et à mesure ; le niveau est calculé automatiquement.",
    ],
    href: "/(supervisor-tabs)/evaluation",
    spot: "top",
  },
  {
    ...
    desc: "Retrouvez ici les inconvénients signalés par les enseignants dans leurs rapports.",
    points: [
      "Filtrez par enseignant ou affichez « Tous les enseignants ».",
      "Chaque signalement est daté pour suivre son évolution.",
    ],
  ...
  },
  {
    ...
    points: [
      ...
      "le détail d'un éventuel incident (obligatoire si incident).",
      "Sans connexion, le rapport part automatiquement à la reconnexion.",
    ],
    href: "/(supervisor-tabs)/rapports",
    spot: "top",
  ...
  },
  {
    ...
    desc: "La barre du haut est toujours à portée de main :",
    points: [
      "Votre avatar (à droite) ouvre votre profil et la déconnexion.",
      "La flèche circulaire force une synchronisation immédiate.",
      "Un badge « Hors-ligne » apparaît dès que le réseau est coupé.",
    ],
    href: "/(supervisor-tabs)/presences",
  ...
  },
  {
    ...
    desc: "Pas de réseau ? Continuez à travailler normalement.",
    points: [
      "Présences, évaluations et rapports sont enregistrés sur le téléphone.",
      "Dès que la connexion revient, tout est envoyé automatiquement.",
    ],
  },
  {
