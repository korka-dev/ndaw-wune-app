...
const SUPERVISOR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    desc: "Vous partez de la liste de vos enseignants : touchez celui que vous évaluez aujourd'hui. Vous verrez ensuite tous ses élèves, et c'est vous qui lancez le tirage au sort sur place.",
  ...
  },
  {
    ...
    icon: "check-square",
    title: "Étape 1 — Tirer les élèves au sort",
    desc: "La liste complète des élèves de l'enseignant s'affiche :",
    points: [
      "Touchez « Tirer au sort » : l'app choisit 2 élèves au hasard.",
      "Les 2 élèves tirés s'affichent — « Retirer » relance le tirage si besoin.",
      "Touchez « Continuer » pour ouvrir le dossier d'évaluation.",
    ],
    href: "/(supervisor-tabs)/evaluation",
    spot: "middle",
  },
  {
    ...
    icon: "file-text",
    title: "Étape 2 — Le dossier d'évaluation",
    desc: "Le dossier de la langue de votre école (Wolof, Pulaar ou Seereer) s'ouvre automatiquement : vous n'avez rien à choisir. Lisez-le avec l'élève — lettres, syllabes, mots et opérations.",
    href: "/(supervisor-tabs)/evaluation",
    spot: "top",
  },
  {
    ...
    desc: "Pour chacun des élèves tirés au sort, observez sa réponse et touchez le résultat correspondant :",
    points: [
