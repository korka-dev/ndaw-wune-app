...
const SUPERVISOR_PAGES: Page[] = [
  {
    ...
    desc: "Pointez chaque jour les présences de vos enseignants : choisissez la semaine et le jour, marquez présent ou absent (avec motif), puis confirmez la liste.",
  },
  {
    icon: "shuffle",
    color: C.brand,
    colorSoft: C.brandSoft,
    title: "Évaluation",
    desc: "L'administrateur crée les sujets et tire les élèves au sort. Ouvrez un sujet, pointez les présents, choisissez le dossier d'évaluation, puis notez chaque élève : Réussi, Intermédiaire ou Pas réussi.",
  },
  {
    icon: "alert-triangle",
    color: C.warn,
    colorSoft: C.warnSoft,
    title: "Difficultés",
    desc: "Consultez les difficultés signalées par vos enseignants dans leurs rapports journaliers. Filtrez par enseignant pour cibler les problèmes récurrents.",
  },
  {
    icon: "send",
    color: C.success,
    colorSoft: C.successSoft,
    title: "Rapports",
    desc: "Envoyez votre rapport de supervision (bilan, classes terminées, incidents) et consultez l'historique de vos envois avec leur statut de validation.",
  },
  {
    icon: "user",
    color: C.textMuted,
    colorSoft: C.surfaceAlt,
    title: "Profil",
    desc: "Vos informations personnelles, votre école, le statut de connexion et la déconnexion sécurisée.",
  },
];
